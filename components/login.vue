...
<template>
  ...
  >
    ...
    <NuxtLink class="flex self-end mb-2 text-blue-600 right-0" to="#">forgot password ?</NuxtLink>
...
<!-- 
   ...
   <UFormGroup name="email" class="text-black w-full mb-5">
      <label for="email" class="text-gray-600 pb-2">Email</label>
      <input
        type="email"
        v-model="state.email"
    ...
    <UFormGroup name="password" class="text-black w-full mb-5">
      <label for="password" class="text-gray-600 pb-2">Password</label>
      <input
        type="password"
        v-model="state.password"
